                  ...
                  <div class="col">
                     ...
                     <select class="custom-select"
                        ...
                        @foreach ($propertyTypes as $propertyType)
                           <option value="{{ $propertyType->id }}">{{ $propertyTypes->name }}</option>
                        @endforeach
                     </select>
                  </div>
               </div>
               ...
               <div class="row mb-2">
                  <div class="col-12">
                     <label for="amenities">{{ __('Amenities') }}
                        ...
                        class="text-muted">{{ 'Please note The page will refrech!' }}</small>
               ...
               <div class="row p-3">
                  <div class="custom-control custom-checkbox">
                     ...
                     <label class="custom-control-label"
                        for="customCheck1">Check this if pets are allowed</label>
                  </div>
               </div>
            </div>
         </div>
